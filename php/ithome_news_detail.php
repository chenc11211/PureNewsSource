...
$title_pos_1=strpos($html,'<div class="post_title">                        <h1>')+52;
$title_pos_2=strpos($html,'</h1>                        <span class="pt_info pre1">');
$title=substr($html,$title_pos_1,$title_pos_2-$title_pos_1);
//echo $title;


$cal_pos_1=strpos($html,'pt_info pre1')+14;
$cal_pos_2=strpos($html,'<span id="editor');
$cal=substr($html,$cal_pos_1,$cal_pos_2-$cal_pos_1);
//echo $cal;

$content_pos_1=strpos($html,'<div class="post_content');
$content_pos_2=strpos($html,'<div class="con-recom">                       <div class="bx-recom4');
        ...
        <div class="container">
            ...
            <div class="navbar-collapse collapse" id="navbar-nav">
                <ul class="nav navbar-nav">
                    ...
                    <li class="active"><a href="../news_ithome.html">IT之家</a></li>
...
<!--巨幕标题-->
<div class="jumbotron" style="background:#bf0028 url('../img/ithome.jpg') no-repeat center 20px">
...
<div class="path container hidden-xs">
    <ol class="breadcrumb">
        <li><a href="../index.html">首页</a></li>
        <li><a href="../news_ithome.html">IT之家新闻</a></li>
        <li class="active"></li>
    </ol>
</div>
